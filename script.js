...
const translations = {
    tr: {
        ...
        "nav-flagship": "Amiral Gemisi",
        "nav-contact": "İletişim",
        "hero-tag": "SAVUNMA • HAVACILIK • OTONOMİ",
        "hero-title": "ADVANCED TEKNOLOJİ MÜHENDİSLİK ve TİC. LTD. ŞTİ.",
        "hero-subtitle": "Yüksek Performanslı Atalet Seyrüsefer ve Sistem Tasarım Çözümleri",
        ...
        "about-p1": "Advanced Teknoloji & Mühendislik; savunma ve havacılık uygulamaları için atalet seyrüsefer sistemleri, MEMS atalet sensör entegrasyonu ve otonom teknolojiler konusunda uzmanlaşmış bir Türk mühendislik şirketidir.",
        ...
        "proj-gps-rot-title": "GPS Rotasyon Sistemi",
        ...
        "proj-landing-desc": "Otonom uçuş için lazer tabanlı irtifa ve dikey hız kestirimi.",
        "cat-3-title": "Dahili Ar-Ge",
        "proj-mag-title": "Manyetometresiz Kalibrasyon",
        ...
        "flag-2-title": "Arazi Referanslı Navigasyon (TRN)",
        ...
        "why-4-title": "Hızlı Prototipleme",
